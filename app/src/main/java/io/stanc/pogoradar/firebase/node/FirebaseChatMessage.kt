...
@Parcelize
class FirebaseChatMessage private constructor(
    override val id: String,
    private val parentDatabasePath: String,
    val message: String,
    val senderId: String,
    val timestamp: Number): FirebaseDataNode, Parcelable {
    ...
    companion object {
        ...
        fun parentDatabasePath(chatId: String): String {
            return "$CHATS/$chatId"
        }

        fun new(parentDatabasePath: String, dataSnapshot: DataSnapshot): FirebaseChatMessage? {
            ...
            if (id != null && message != null && senderId != null && timestamp != null) {
                return FirebaseChatMessage(id, parentDatabasePath, message, senderId, timestamp)
            }

            return null
        }

        fun new(parentDatabasePath: String, senderId: String, message: String): FirebaseChatMessage {
            return FirebaseChatMessage("", parentDatabasePath, message, senderId, TIMESTAMP_SERVER)
        }
    }
}